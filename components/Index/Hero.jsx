...
export default function Hero() {
    const { data: _projects } = swr('https://nils-afk.github.io/projects/list.json', 600000);
        ...
        <div className="relative w-full sm:grid sm:grid-cols-2 sm:gap-x-12 pb-10 pt-5 sm:pt-0">
            ...
            <div className="flex items-center">
                <div className="text-center sm:text-right w-full">
                    ...
                    <p className="pt-3 w-4/5 lg:w-8/12 mx-auto sm:mr-0 sm:ml-auto text-gray-400">Full-Stack Developer. I live in Germany. I'm high school student and self-improvement person.</p>
                </div>
            </div>
